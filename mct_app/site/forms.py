...
class QuestionForm(FlaskForm):
    """Class for the form to ask question."""
...
class AnswerForm(FlaskForm):
    """Class for from of an doctor's answer."""
...
class ConsultationForm(FlaskForm):
    """Class for form of consulatation."""
    ...
    first_name = StringField(
        ...
        validators=[
            ...
            Length(
                min=2, max=25,
                message='Длина имени не может быть меньше 2'
                'и больше 25 символов')])
    last_name = StringField(
        'Ваша фамилия',
        render_kw={'placeholder': 'Введите вашу фамилию'},
        validators=[DataRequired('Необходимо ввести фамилию'),
                    Length(min=2, max=25,
                    message='Длина фамилии не может быть меньше 2'
                            'и больше 25 символов')])
    phone = StringField(
        'Номер телефона с WhatsUp/Telegram',
        validators=[DataRequired('Не был введен номер телефона')])

    def validate_first_name(self, first_name: str) -> bool:
    ...
    def validate_last_name(self, last_name: str) -> bool:
    ...
    def validate_phone(self, phone):
        """Validate correctness of phone number."""
        try:
